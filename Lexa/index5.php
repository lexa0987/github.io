    ...
    <div class="content">
    	<div class="con">
    		...
    		<div class="price">
    			<div class="block">
    			   <div class="main_foto">
    				<img src="img/1.jpg" width="360" height="360">

    			   </div>
    			   <div class="info">
    				   <p id="f"><b>New Balance x Aime Leon Dore 993</b></p>		   
    				   <p class="ff"><b>Материал:</b> Верх - замша, текстиль.</p>
    				   <p class="ff"><b>Подкладка:</b> текстиль.</p>
    				   <p class="ff"><b>Коллаборация:</b> New Balance x Aime Leon Dore</p>
                ...
                <div class="otovare">
                	<h2>О товаре</h2>
               	    <p>Кроссовки имеют сетчатую основу с накладками из замши,черной резиновой подошвы и бежево-синей расцветке. Подкладка и шнурки сделаны черными.</p>
